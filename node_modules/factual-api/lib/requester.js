  ...
  getCallback: function (req) {
    ...
    return function (error, data, response) {
      ...
      try {
        ...
        //console.log(JSON.stringify(Object.keys(response.headers)));
        console.log("response.headers from factual requester.js: ", JSON.parse(response.headers["x-factual-throttle-allocation"]));
        //var burst = JSON.parse(response.headers["x-factual-throttle-allocation"])["burst"];
